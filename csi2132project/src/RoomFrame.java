...
public class RoomFrame extends JFrame {
	...
	public RoomFrame(MainFrame owner) {
        ...
        add.addActionListener(new RoomAddListener(this));
        		...
        		new ActionListener() {
        			public void actionPerformed(ActionEvent aEvent) {
        				try {
        					...
        					if(selected != -1 && selected < roomModel.getRowCount()) {
        						rset.absolute(table.getSelectedRow() + 1);
        						rset.deleteRow();
        						table.repaint();
        						table.clearSelection();
        					}
        	            	roomModel = new RoomTableModel(rset);
        				}
        ...
        edit.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent aEvent) {
    			ResultSet rset = myDB.getResultSet();
    			RoomUpdateDialog updateRoom = new RoomUpdateDialog(RoomFrame.this, rset);
